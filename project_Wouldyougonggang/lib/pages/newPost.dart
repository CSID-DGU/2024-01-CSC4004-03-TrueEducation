              ...
              children: [
                Container(
                  ...
                  child: Container(
                    ...
                    child: Container(
                      padding: const EdgeInsets.fromLTRB(10, 10, 325, 120),
                      child: Text(
                        '사진',
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: Container(
                      padding: const EdgeInsets.fromLTRB(10, 10, 325, 10),
                      child: Text(
                        '이름',
                        style: GoogleFonts.getFont(
                          'Inter',
                  ...
                  child: Container(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            margin: const EdgeInsets.fromLTRB(0, 1.8, 11, 2.8),
                            child: SizedBox(
                              width: 262.2,
                              child: Row(
                                children: [
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: Container(
                      height: 250,
                      padding: const EdgeInsets.fromLTRB(8, 7, 295, 0),
                      child: Text(
                        '상세설명',
                        style: GoogleFonts.getFont(
                          'Inter',
